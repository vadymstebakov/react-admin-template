...
const RatScrollbars = forwardRef((props, ref) => {
    ref = ref || createRef();
...
function mapStateToProps({ theme }) {
    return {
        customScrollbars: theme.settings.current.customScrollbars,
    };
}

RatScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(withRouterAndRef(RatScrollbars));
