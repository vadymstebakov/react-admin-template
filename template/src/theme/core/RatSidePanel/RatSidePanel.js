        ...
        <>
            <Hidden mdDown>
                <Paper
                    ...
                    square
                >
                    <RatScrollbars className={clsx('content', classes.content)}>{props.children}</RatScrollbars>
...
RatSidePanel.propTypes = {};
RatSidePanel.defaultProps = {
    position: 'left',
    opened: true,
};

export default memo(RatSidePanel);
