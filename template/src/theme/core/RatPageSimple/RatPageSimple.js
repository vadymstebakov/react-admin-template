...
import RatPageSimpleHeader from './RatPageSimpleHeader';
import RatPageSimpleSidebar from './RatPageSimpleSidebar';
...
const RatPageSimple = forwardRef((props, ref) => {
    // console.info("render::RatPageSimple");
    ...
    return (
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex flex-auto flex-col container z-10 h-full">
                {props.header && props.sidebarInner && <RatPageSimpleHeader header={props.header} classes={classes} />}

                <div className={classes.wrapper}>
                    {(props.leftSidebarHeader || props.leftSidebarContent) && (
                        <RatPageSimpleSidebar
                            position="left"
                    ...
                    {/* > */}
                    <RatScrollbars className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
                        {props.header && !props.sidebarInner && (
                            <RatPageSimpleHeader header={props.header} classes={classes} />
                        )}
...
RatPageSimple.defaultProps = {};

export default memo(RatPageSimple);
