...
import RatPageSimpleSidebarContent from './RatPageSimpleSidebarContent';

function RatPageSimpleSidebar(props, ref) {
    ...
    return (
        <>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <RatPageSimpleSidebarContent {...props} />
                </SwipeableDrawer>
            </Hidden>
...
export default forwardRef(RatPageSimpleSidebar);
