...
import RatPageCardedSidebarContent from './RatPageCardedSidebarContent';

function RatPageCardedSidebar(props, ref) {
    ...
    return (
        <>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <RatPageCardedSidebarContent {...props} />
                </SwipeableDrawer>
            </Hidden>
...
export default forwardRef(RatPageCardedSidebar);
