...
import RatPageCardedHeader from './RatPageCardedHeader';
import RatPageCardedSidebar from './RatPageCardedSidebar';
...
const RatPageCarded = forwardRef((props, ref) => {
    ...
    return (
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex container w-full">
                ...
                >
                    <RatPageCardedHeader header={props.header} classes={classes} />
...
RatPageCarded.defaultProps = {};

export default memo(RatPageCarded);
