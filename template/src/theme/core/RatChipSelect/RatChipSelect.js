...
function RatChipSelect(props) {
    ...
    return props.variant === 'fixed' ? (
        <Select classNamePrefix="rat-chip-select" {...props} components={components} onChange={handleOnChange} />
    ) : (
        <Creatable classNamePrefix="rat-chip-select" {...props} components={components} onChange={handleOnChange} />
    );
}

export default memo(RatChipSelect);
