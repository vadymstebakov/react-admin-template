...
function RatHighlight(props) {
    ...
    function trimCode() {
        ...
        // can be formatted properly while using t-highlight
        // component
...
RatHighlight.propTypes = {
    component: PropTypes.node,
};
RatHighlight.defaultProps = {
    component: 'code',
};

export default memo(RatHighlight);
