import RatHighlight from '@theme/core/RatHighlight';
                ...
                <div className={currentTab === 1 ? 'flex flex-1' : 'hidden'}>
                    {raw && (
                        <div className="flex flex-1">
                            <RatHighlight component="pre" className="language-javascript w-full">
                                {raw.default}
                            </RatHighlight>
                        </div>
                    )}
...
RatExample.propTypes = propTypes;
RatExample.defaultProps = defaultProps;

export default RatExample;
