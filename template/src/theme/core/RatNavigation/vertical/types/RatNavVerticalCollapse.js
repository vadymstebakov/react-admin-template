...
function RatNavVerticalCollapse(props) {
    ...
    return useMemo(
        () => (
            <ul className={clsx(classes.root, open && 'open')}>
                ...
                >
                    {item.icon && (
                        <Icon color="action" className="rat-list-item-icon text-20 flex-shrink-0">
                            {item.icon}
                        </Icon>
                    )}
...
RatNavVerticalCollapse.propTypes = {
...
RatNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = RatNavVerticalCollapse;
