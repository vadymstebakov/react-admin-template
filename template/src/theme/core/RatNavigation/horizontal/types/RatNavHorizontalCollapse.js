...
function RatNavHorizontalCollapse(props) {
                        ...
                        {({ ref }) => (
                            <div ref={ref}>
                                <ListItem
                                    ...
                                    aria-owns={opened ? 'menu-rat-list-grow' : null}
                                    aria-haspopup="true"
                                ...
                                >
                                    {item.icon && (
                                        <Icon color="action" className="rat-list-item-icon text-16 flex-shrink-0">
                                            {item.icon}
                                        </Icon>
                                    )}
                                    ...
                                    {item.badge && <RatNavBadge className="mx-4" badge={item.badge} />}
                                    <IconButton
                                        disableRipple
                        ...
                        >
                            {({ ref, style, placement, arrowProps }) =>
                                opened && (
                                    ...
                                    >
                                        <Grow in={opened} id="menu-rat-list-grow" style={{ transformOrigin: '0 0 0' }}>
                                            <Paper
                                                className="rounded-8"
                                                onMouseEnter={() => handleToggle(true)}
                                                onMouseLeave={() => handleToggle(false)}
...
RatNavHorizontalCollapse.propTypes = {
...
RatNavHorizontalCollapse.defaultProps = {};

const NavHorizontalCollapse = withRouter(memo(RatNavHorizontalCollapse));
