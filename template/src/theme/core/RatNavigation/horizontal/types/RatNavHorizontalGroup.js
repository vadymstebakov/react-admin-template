...
function RatNavHorizontalGroup(props) {
...
RatNavHorizontalGroup.propTypes = {
...
RatNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(memo(RatNavHorizontalGroup));
