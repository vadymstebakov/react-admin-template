...
import { selectFlatNavigation } from '@store/modules/theme/navigation/navigationSlice';
...
const RatShortcuts = props => {
    const dispatch = useDispatch();
    const shortcuts = useSelector(({ auth }) => auth.userAuth.data.shortcuts);
    ...
    function toggleInShortcuts(id) {
        ...
        dispatch(userAuthActions.updateUserShortcuts(newShortcuts));
    }
...
RatShortcuts.propTypes = {};
RatShortcuts.defaultProps = {
    variant: 'horizontal',
};

export default memo(RatShortcuts);
