...
const useStyles = makeStyles(theme => ({
    ...
    foldedAndClosed: {
        '& $navbarContent': {
            ...
            '& .rat-list-item-text, & .arrow-icon, & .item-badge': {
                opacity: 0,
            },
            '& .rat-list-subheader .rat-list-subheader-text': {
                opacity: 0,
            },
            '& .rat-list-subheader:before': {
                content: '""',
                display: 'block',
                position: 'absolute',
                minWidth: 16,
            ...
            >
                <Hidden mdDown>
                    <div
                        ...
                        onMouseEnter={() => foldedAndClosed && dispatch(navbarActions.navbarOpenFolded())}
                        onMouseLeave={() => foldedAndOpened && dispatch(navbarActions.navbarCloseFolded())}
                    >
