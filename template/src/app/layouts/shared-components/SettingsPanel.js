...
import RatSettings from '@theme/core/RatSettings';
...
import RatThemeSchemes from '@theme/core/RatThemeSchemes';
...
function SettingsPanel() {
    ...
    return (
        <>
            <div className={classes.buttonWrapper} id="rat-settings-schemes">
                <Button
            ...
            <Dialog
                ...
                {...settingsHandlers}
            >
                <RatScrollbars className="p-16 sm:p-32">
