...
import RatDialog from '@theme/core/RatDialog';
import RatMessage from '@theme/core/RatMessage';
import RatSuspense from '@theme/core/RatSuspense';
...
function Layout3(props) {
    ...
    return (
        <AppContext.Consumer>
            {({ routes }) => (
                <div id="rat-layout" className={clsx(classes.root, config.mode, 'w-full flex flex')}>
                    {config.leftSidePanel.display && <LeftSideLayout3 />}

                    <div className="flex flex-col flex-auto min-w-0">
                        <main id="rat-main" className="flex flex-col flex-auto min-h-screen min-w-0 relative">
                            ...
                            <div className="flex flex-col flex-auto min-h-0 relative z-10">
                                ...
                                <RatSuspense>{renderRoutes(routes)}</RatSuspense>
